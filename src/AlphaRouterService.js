...
const name2 = 'TetherUSD Token'
const symbol2 = 'USDT'
const decimals2 = 6
const address2 = '0xdAC17F958D2ee523a2206206994597C13D831ec7'

const WETH = new Token(chainId, address0, decimals0, symbol0, name0)
const UNI = new Token(chainId, address1, decimals1, symbol1, name1)
const USDT = new Token(chainId, address2, decimals2, symbol2, name2)
...
export const getUsdtContract = () => new ethers.Contract(address2, ERC20ABI, web3Provider)
